...
// Il preprocessore del C sostituirà ad GRID_COLS il valore che c'è alla sua destra (25)
// È una sostituzione testuale
#define GRID_COLS 20
#define GRID_ROWS 20
// Messo tra parentesi per non avere problemi con la precedenza degli operatori se
// GRID_CELLS fosse usato in espressioni più complesse
#define GRID_CELLS (GRID_COLS * GRID_ROWS)
#define ALIVE '*'
#define DEAD '.'

/* Translate the specified x,y grid point int the index in
...
int main(void) {
  // Useremo il . per le celle morte e * per le celle vive
